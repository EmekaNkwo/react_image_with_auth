...
const ImageWithToken = ({ imageUrl, token, headers, alt = "Image", placeholder, fallback, className, style, onClick, }) => {
    ...
    return (react_1.default.createElement("img", { src: error && fallback ? fallback : imgSrc, alt: alt, className: className, style: style, onError: () => setError(true), onClick: onClick }));
};
